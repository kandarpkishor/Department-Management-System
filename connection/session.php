...
$ses_sql=mysqli_query($connect, "SELECT *FROM user WHERE USERNAME='$user_check'");
...
$login_user_roll =$row2['ROLL'];
$login_user_sem =$row2['SEMESTER'];
$login_user_session =$row2['SESSION'];
